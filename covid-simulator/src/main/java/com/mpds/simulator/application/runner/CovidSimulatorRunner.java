...
//    private final DomainEventPublisherReactive domainEventPublisherReactive;
    ...
    public void run(String... args) throws Exception {
        ...
        Coordinate overlap = new Coordinate(this.simulatorProps.getInfectionDistance(), this.simulatorProps.getInfectionDistance());
        GridBins grid = new GridBins(this.domainEventPublisher, size, binSize, this.simulatorProps.getInfectionDistance(), 30);
