...
public class CovidSimulatorRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        GridBins grid = new GridBins(this.domainEventPublisher, size, binSize, this.simulatorProps.getInfectionDistance(), simulatorProps.getDaysInfected(), simulatorProps.getTicksPerDay(), simulatorProps.getPublishInfectionAfterXDays());
