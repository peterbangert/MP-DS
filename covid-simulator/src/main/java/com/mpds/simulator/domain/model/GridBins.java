...
public class GridBins {
    ...
    public GridBins(Coordinate size, Coordinate binSize, Coordinate overlapSize, int infectionDistance, int infectionTime){
        ...
        for(int r=0; r<binsPerRow-1; r++){
            ...
            bins[r][binsPerCol-1] = new Bin(upperLeft, lowerRight, new Coordinate(overlapSize.getRow(), 0), infectionDistance, infectionTime,this);
        }
        ...
        for(int c=0; c<binsPerCol-1; c++){
            ...
            bins[binsPerRow-1][c] = new Bin(upperLeft, lowerRight, new Coordinate(0, overlapSize.getCol()), infectionDistance, infectionTime,this);
        }
