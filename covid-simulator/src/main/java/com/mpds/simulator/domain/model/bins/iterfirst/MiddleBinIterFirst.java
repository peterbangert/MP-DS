...
public class MiddleBinIterFirst extends MiddleBin {

    public MiddleBinIterFirst(DomainEventPublisher domainEventPublisher, Coordinate ulCorner, Coordinate lrCorner){
