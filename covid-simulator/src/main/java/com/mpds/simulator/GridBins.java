    ...
    public GridBins(Coordinate size, Coordinate binSize, Coordinate overlapSize){
        ...
        for(int r=0; r<binsPerRow-1; r++){
            for(int c=0; c<binsPerCol-1; c++){
                ...
                lowerRight = new Coordinate(binSize.row * (r+1), binSize.col * (c+1));
        ...
        for(int r=0; r<binsPerRow-1; r++){
            ...
            lowerRight = new Coordinate(binSize.row * (r+1), size.col-1);
        ...
        for(int c=0; c<binsPerCol-1; c++){
            ...
            lowerRight = new Coordinate(size.row-1, binSize.col * (c+1));
